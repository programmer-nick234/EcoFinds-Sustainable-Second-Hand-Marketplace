...
// Validate ../../src/app/products/create/page.tsx
{
  ...
  handler satisfies AppPageConfig<"/products/create">
}

// Validate ../../src/app/products/my-products/page.tsx
{
  const handler = {} as typeof import("../../src/app/products/my-products/page.js")
  handler satisfies AppPageConfig<"/products/my-products">
}
